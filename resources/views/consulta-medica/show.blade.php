...
<div class="container">
    ...
    <div class="card shadow-2 p-4 mb-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-md-8"><strong class="text-muted small">Síntomas:</strong><br>{{ $consulta->sintomas }}</div>
            @endif
            @if ($consulta->tiempo_evolucion)
            <div class="col-12 col-md-4"><strong class="text-muted small">Tiempo de evolución:</strong><br>{{ $consulta->tiempo_evolucion }}</div>
            @endif
        </div>
    </div>
    ...
    <div class="card shadow-2 p-4 mb-4">
        <h6 class="fw-bold mb-3" style="color:#1266f1">Dolores</h6>
    ...
    <div class="card shadow-2 p-4 mb-4">
        ...
        <div class="row g-3">
            ...
            @if ($consulta->imc)<div class="col-12 col-md-3"><strong class="text-muted small">IMC:</strong><br>{{ $consulta->imc }}</div>@endif
        </div>
    </div>
