...
<div class="container">
    ...
    <form action="{{ route('consulta-medica.store', $cita->id) }}" method="POST">
        ...
        <div class="card shadow-2 p-4 mb-4">
            <h6 class="fw-bold mb-3" style="color:#1266f1">Motivo y síntomas</h6>
            <div class="row g-3">
                <div class="col-12">
                ...
                <div class="col-md-8">
                    ...
                    <textarea name="sintomas" rows="2" class="form-control @error('sintomas') is-invalid @enderror">{{ old('sintomas', $consulta->sintomas ?? '') }}</textarea>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="tiempo_evolucion" class="form-control @error('tiempo_evolucion') is-invalid @enderror" value="{{ old('tiempo_evolucion', $consulta->tiempo_evolucion ?? '') }}">
            ...
            <div id="doloresContainer">
                ...
                <div class="dolor-row row g-3 align-items-end mb-2 p-2" style="border-radius:12px;">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="dolores[{{ $i }}][ubicacion]" class="form-control" value="{{ $dolor['ubicacion'] ?? '' }}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label text-muted small">Intensidad</label>
                        <input type="text" name="dolores[{{ $i }}][intensidad]" class="form-control" value="{{ $dolor['intensidad'] ?? '' }}">
                    </div>
                    <div class="col-md-3">
...
<button type="button" class="btn btn-outline-secondary btn-sm btn-remove-dolor" style="background:#e74c3c;color:#fff;border:none;"><i class="fa-regular fa-trash-can me-1"></i>Eliminar</button>
        ...
        <div class="card shadow-2 p-4 mb-4">
            <h6 class="fw-bold mb-3" style="color:#1266f1">Signos vitales</h6>
            <div class="row g-3">
                <div class="col-md-3">
                    <label class="form-label text-muted small">Presión arterial</label>
                    <input type="text" name="presion_arterial" class="form-control @error('presion_arterial') is-invalid @enderror" placeholder="120/80" value="{{ old('presion_arterial', $consulta->presion_arterial ?? '') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.1" name="temperatura" class="form-control @error('temperatura') is-invalid @enderror" value="{{ old('temperatura', $consulta->temperatura ?? '') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="frecuencia_cardiaca" class="form-control @error('frecuencia_cardiaca') is-invalid @enderror" value="{{ old('frecuencia_cardiaca', $consulta->frecuencia_cardiaca ?? '') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="frecuencia_respiratoria" class="form-control @error('frecuencia_respiratoria') is-invalid @enderror" value="{{ old('frecuencia_respiratoria', $consulta->frecuencia_respiratoria ?? '') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="saturacion_oxigeno" class="form-control @error('saturacion_oxigeno') is-invalid @enderror" value="{{ old('saturacion_oxigeno', $consulta->saturacion_oxigeno ?? '') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.1" name="peso" class="form-control @error('peso') is-invalid @enderror" value="{{ old('peso', $consulta->peso ?? '') }}">
                    @error('peso')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <label class="form-label text-muted small">Estatura (cm)</label>
                    <input type="number" step="0.1" name="estatura" class="form-control @error('estatura') is-invalid @enderror" value="{{ old('estatura', $consulta->estatura ?? '') }}">
                    @error('estatura')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <label class="form-label text-muted small">IMC</label>
                    <input type="number" step="0.1" name="imc" class="form-control @error('imc') is-invalid @enderror" value="{{ old('imc', $consulta->imc ?? '') }}">
        ...
        <div class="card shadow-2 p-4 mb-4">
            <h6 class="fw-bold mb-3" style="color:#1266f1">Exploración y diagnóstico</h6>
            <div class="row g-3">
                <div class="col-12">
                    <label class="form-label text-muted small">Exploración física</label>
                    <textarea name="exploracion_fisica" rows="3" class="form-control @error('exploracion_fisica') is-invalid @enderror">{{ old('exploracion_fisica', $consulta->exploracion_fisica ?? '') }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea name="observaciones" rows="2" class="form-control @error('observaciones') is-invalid @enderror">{{ old('observaciones', $consulta->observaciones ?? '') }}</textarea>
                    @error('observaciones')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label text-muted small">Diagnóstico probable</label>
                    <textarea name="diagnostico_probable" rows="2" class="form-control @error('diagnostico_probable') is-invalid @enderror">{{ old('diagnostico_probable', $consulta->diagnostico_probable ?? '') }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="diagnostico_final" rows="2" class="form-control @error('diagnostico_final') is-invalid @enderror">{{ old('diagnostico_final', $consulta->diagnostico_final ?? '') }}</textarea>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="codigo_cie10" class="form-control @error('codigo_cie10') is-invalid @enderror" placeholder="Ej. J00.X" value="{{ old('codigo_cie10', $consulta->codigo_cie10 ?? '') }}">
                ...
                <div class="receta-card neu-card p-3 mb-3" style="border-radius:12px;">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea name="recetas[{{ $ri }}][diagnostico]" rows="2" class="form-control @error('recetas.'.$ri.'.diagnostico') is-invalid @enderror" required>{{ $receta['diagnostico'] ?? '' }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="recetas[{{ $ri }}][indicaciones_generales]" rows="2" class="form-control @error('recetas.'.$ri.'.indicaciones_generales') is-invalid @enderror" required>{{ $receta['indicaciones_generales'] ?? '' }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="recetas[{{ $ri }}][notas]" rows="1" class="form-control @error('recetas.'.$ri.'.notas') is-invalid @enderror">{{ $receta['notas'] ?? '' }}</textarea>
                    ...
                    <div class="medicamentos-container">
                        ...
                        <div class="row g-2 mb-2 medicamento-row align-items-end">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="recetas[{{ $ri }}][medicamentos][{{ $mi }}][nombre]" class="form-control" placeholder="Medicamento" value="{{ $med['medicamento'] ?? $med['nombre'] ?? '' }}">
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="recetas[{{ $ri }}][medicamentos][{{ $mi }}][dosis]" class="form-control" placeholder="Dosis" value="{{ $med['dosis'] ?? '' }}">
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="recetas[{{ $ri }}][medicamentos][{{ $mi }}][frecuencia]" class="form-control" placeholder="Frecuencia" value="{{ $med['frecuencia'] ?? '' }}">
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="recetas[{{ $ri }}][medicamentos][{{ $mi }}][duracion]" class="form-control" placeholder="Duración" value="{{ $med['duracion'] ?? '' }}">
                            </div>
                            <div class="col-md-2">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnAgregarDolor.addEventListener('click', function () {
            ...
            row.innerHTML = `
                ...
                <div class="col-md-4">
                    <label class="form-label text-muted small">Ubicación</label>
                    <input type="text" name="dolores[${dolorIndex}][ubicacion]" class="form-control" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label text-muted small">Intensidad</label>
                    <input type="text" name="dolores[${dolorIndex}][intensidad]" class="form-control">
                </div>
                <div class="col-md-3">
                    <label class="form-label text-muted small">Duración</label>
        ...
        function crearRecetaCard(ri) {
            ...
            card.innerHTML = `
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label class="form-label text-muted small">Diagnóstico</label>
                        <textarea name="recetas[${ri}][diagnostico]" rows="2" class="form-control" required></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted small">Indicaciones generales</label>
                        <textarea name="recetas[${ri}][indicaciones_generales]" rows="2" class="form-control" required></textarea>
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label text-muted small">Notas adicionales</label>
                    <textarea name="recetas[${ri}][notas]" rows="1" class="form-control"></textarea>
                </div>
                <div class="mb-2">
                    <label class="form-label text-muted small">Medicamentos</label>
                    <button type="button" class="btn btn-outline-secondary btn-sm btn-agregar-med-receta ms-2" data-receta="${ri}"><i class="fa-solid fa-plus me-1"></i>+</button>
        ...
        document.getElementById('recetasContainer').addEventListener('click', function (e) {
            if (e.target.classList.contains('btn-agregar-med-receta')) {
                ...
                row.innerHTML = `
                    ...
                    <div class="col-md-3">
                        <input type="text" name="recetas[${ri}][medicamentos][${mi}][nombre]" class="form-control" placeholder="Medicamento">
                    </div>
                    <div class="col-md-2">
                        <input type="text" name="recetas[${ri}][medicamentos][${mi}][dosis]" class="form-control" placeholder="Dosis">
                    </div>
                    <div class="col-md-2">
                        <input type="text" name="recetas[${ri}][medicamentos][${mi}][frecuencia]" class="form-control" placeholder="Frecuencia">
                    </div>
                    <div class="col-md-2">
                        <input type="text" name="recetas[${ri}][medicamentos][${mi}][duracion]" class="form-control" placeholder="Duración">
                    </div>
                    <div class="col-md-2">
