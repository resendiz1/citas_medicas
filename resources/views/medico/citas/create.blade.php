    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8">
            <div class="card shadow-2 p-4">
                <h4 class="mb-4 fw-bold"><i class="fa fa-calendar-plus me-2" style="color:#1266f1"></i>Agendar Cita</h4>
                <form method="POST" action="{{ route('medico.citas.store') }}" id="citaForm">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select id="paciente_id" name="paciente_id"
                            ...
                            @foreach ($pacientes as $paciente)
                                <option value="{{ $paciente->id }}" {{ old('paciente_id', $pacienteSeleccionado) == $paciente->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-4" id="calendar-wrapper" style="display:none">
                        ...
                        <div id="sin-horarios-msg" class="flex-column align-items-center py-4" style="display:none">
                            ...
                            <p class="fw-bold text-muted mb-0" style="font-size:1.1rem">Aún no has configurado tus horarios.</p>
                        </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fa fa-calendar-check me-1"></i><span class="btn-text">Agendar cita</span></button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    function mostrarHorarios(dateStr) {
        ...
        const horarios = getHorariosDelDia(diaSem);
        const ocupadas = getCitasOcupadas(dateStr);
