    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card shadow-2 p-4">
                <h4 class="mb-4 fw-bold"><i class="fa fa-user-edit me-2" style="color:#1266f1"></i>Editar Paciente</h4>
                <form method="POST" action="{{ route('medico.pacientes.update', $paciente->id) }}">
                    @csrf @method('PUT')
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('medico.pacientes.index') }}" class="btn btn-outline-secondary"><i class="fa fa-xmark me-1"></i>Cancelar</a>
