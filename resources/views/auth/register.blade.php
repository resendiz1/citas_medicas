            ...
            <div class="neu-card p-4 mt-5">
                <h4 class="text-center mb-4">Registro</h4>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <a href="#" id="google-register-btn" class="neu-btn w-100 mb-3 d-flex align-items-center justify-content-center gap-2" style="font-size:0.85rem;background:#fff;color:#333">
