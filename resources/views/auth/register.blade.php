            ...
            <div class="card shadow-2 p-4 mt-5">
                <h4 class="text-center mb-4">Registro</h4>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <button type="submit" class="btn btn-primary w-100 mb-3"><i class="fa-solid fa-user-plus me-1"></i>Crear cuenta</button>

                        <div class="text-center mb-3">
                            <span style="font-size:0.85rem;color:var(--text-secondary)">o</span>
                        </div>

                        <a href="#" id="google-register-btn" class="btn btn-outline-secondary w-100 mb-3 d-flex align-items-center justify-content-center gap-2" style="font-size:0.85rem;background:#fff;color:#333">
