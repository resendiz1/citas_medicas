...
return [
    ...
    'attributes' => [
        ...
        'recetas.*.medicamentos.*.nombre_generico' => 'nombre genérico',
        'recetas.*.medicamentos.*.nombre_comercial' => 'nombre comercial',
        'recetas.*.medicamentos.*.presentacion' => 'presentación',
        'recetas.*.medicamentos.*.forma_farmaceutica' => 'forma farmacéutica',
        'recetas.*.medicamentos.*.via_administracion' => 'vía de administración',
        'recetas.*.medicamentos.*.cantidad_total' => 'cantidad total',
        'fecha_inicio_sintomas' => 'fecha de inicio de síntomas',
        'forma_inicio' => 'forma de inicio',
        'evolucion' => 'evolución',
        'descripcion_padecimiento' => 'descripción del padecimiento',
        'exploracion_sin_hallazgos' => 'sin hallazgos relevantes',
        ...
        'plan_medicamentos' => 'medicamentos indicados',
        'plan_estudios' => 'estudios solicitados',
        'plan_procedimientos' => 'procedimientos',
        'plan_recomendaciones' => 'recomendaciones generales',
        'plan_signos_alarma' => 'signos de alarma',
        'plan_referencia' => 'referencia a especialista',
        'plan_seguimiento_fecha' => 'fecha sugerida de seguimiento',
        'plan_incapacidad' => 'incapacidad',
        'sintomas_lista.*.nombre' => 'nombre del síntoma',
        'sintomas_lista.*.ubicacion' => 'ubicación del síntoma',
        'sintomas_lista.*.intensidad_categoria' => 'intensidad del síntoma',
        'sintomas_lista.*.inicio' => 'inicio del síntoma',
        'sintomas_lista.*.duracion' => 'duración del síntoma',
        'sintomas_lista.*.frecuencia' => 'frecuencia del síntoma',
    ],
];
